...
#     return f'Total students: {len(student_count)}'
...
def add_student():
    ...
    if request.method == 'POST':
        ...
        #SQL Insert query
        querry = 'INSERT INTO students (first_name, last_name, gender, mobile_no, course_name, email) VALUES (%s, %s, %s, %s, %s, %s)'
...
def assign_task():
    ...
    #Fetch students and tasks for dropdowns
    cursor.execute("SELECT * FROM students")
    students = cursor.fetchall()
